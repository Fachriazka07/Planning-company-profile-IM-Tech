...
const services: Service[] = [
  {
    ...
    description:
      'Kami menyediakan layanan pengembangan website yang dirancang sesuai kebutuhan bisnis mulai dari company profile.',
  ...
  },
  {
    ...
    description:
      'Kami mengembangkan aplikasi mobile untuk Android yang dirancang untuk memberikan pengalaman pengguna yang nyaman.',
    thumbnail_url: '/placeholder.jpg',
    icon: 'Smartphone',
    features: ['Desain modern & profesional', 'Responsif di semua perangkat', 'SEO Friendly'],
    order: 2,
  ...
  },
  {
    ...
    slug: 'ui-ux-design',
    description:
      'Kami merancang desain UI/UX yang berfokus pada kenyamanan, kemudahan dan kebutuhan pengguna setiap desain dibuat memikat.',
    thumbnail_url: '/placeholder.jpg',
    icon: 'Palette',
    features: ['Desain modern & profesional', 'Responsif di semua perangkat', 'SEO Friendly'],
    order: 3,
  ...
  },
  {
    ...
    description:
      'Kami menyediakan layanan maintenance dan support untuk memastikan website dan aplikasi tetap berjalan stabil.',
    thumbnail_url: '/placeholder.jpg',
    icon: 'Wrench',
    features: ['Desain modern & profesional', 'Responsif di semua perangkat', 'SEO Friendly'],
    order: 4,
