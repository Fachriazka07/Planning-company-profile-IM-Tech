...
const posts: BlogPost[] = [
  {
    ...
    excerpt:
      'Exploring how Artificial Intelligence is reshaping the landscape of modern web development.',
    content: '',
  ...
  },
  {
    ...
    excerpt:
      'A deep dive into React Server Components and how they improve performance in Next.js 15 applications.',
    content: '',
    thumbnail_url: '/placeholder.jpg',
    author_id: '2',
    author: {
  ...
  },
  {
    ...
    excerpt:
      'Stay ahead of the curve with these emerging design trends that are dominating the digital space.',
    content: '',
    thumbnail_url: '/placeholder.jpg',
    author_id: '3',
    author: {
