...
=========================
Script untuk memeriksa kesehatan dokumen di AI-Agent workspace.
...
# ============================================================
# CONFIGURATION - Auto-detect workspace path
# ============================================================
...
WORKSPACE_CANDIDATES = ['AI-Agent', 'agent-workspace']
WORKSPACE_DIR = None
...
if not WORKSPACE_DIR:
    ...
    print("   Tip: Make sure 'AI-Agent/' or 'agent-workspace/' folder exists")
    exit(1)
...
# Patterns to IGNORE (intentional references to files outside workspace)
